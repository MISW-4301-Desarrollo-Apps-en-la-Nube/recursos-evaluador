...
docker build --platform=linux/amd64 ./public -t ghcr.io/misw-4301-desarrollo-apps-en-la-nube/entrega2-public:latest
...
docker push ghcr.io/misw-4301-desarrollo-apps-en-la-nube/entrega2-public:latest
```